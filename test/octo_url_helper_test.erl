...
pull_request_commits_url_3_test_() ->
  [?_assertEqual(
...
pull_request_files_url_3_test_() ->
  [?_assertEqual(
...
pull_request_merged_url_3_test_() ->
  [?_assertEqual(
...
merge_pull_request_url_3_test_() ->
  [?_assertEqual(
     "https://api.github.com/repos/sdepold/octo.erl/pulls/12/merge",
