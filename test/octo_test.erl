...
list_pull_request_commits_test() ->
  ...
  {ok, Result} = octo:list_pull_request_commits("octocat", "Hello-World", 1347),
...
list_pull_request_files_test() ->
  ...
  {ok, Result} = octo:list_pull_request_files("octocat", "Hello-World", 1347),
  ?assertEqual(Expected, Result),
...
create_pull_request_test() ->
  ...
  {ok, Result} = octo:create_pull_request("octocat", "Hello-World", undefined),
  ?assertEqual(Expected, Result),
...
create_reference_test() ->
  ...
  {ok, Result} = octo:create_reference("octocat", "Hello-World", undefined),
